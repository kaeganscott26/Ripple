...
It is not an AI system, backend service, Minecraft build, Docker app, or direct rewrite of the source archive. v0.2 focuses on stabilization, tests, custom Boulder naming, and local browser persistence.
